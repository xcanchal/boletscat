...
export function renderSpeciesPage(species, catalog) {
  ...
  const mapCopy = species.prediction.available
    ? `Compara les condicions actuals del ${species.names.ca.toLowerCase()} sobre el mapa de Catalunya.`
